...
namespace Buttplug4Net35.Messages
{
    ...
    public class DeviceList : ButtplugMessage, IButtplugMessageOutgoingOnly
    {
        ...
        /// </summary>
        public DeviceMessageInfo[] Devices = new DeviceMessageInfo[0];
    ...
    public class RequestServerInfo : ButtplugMessage
    {
        ...
        public RequestServerInfo(string aClientName, uint aId = ButtplugConsts.DefaultMsgId, uint aSchemaVersion = 1)
            : base(aId)
        {
